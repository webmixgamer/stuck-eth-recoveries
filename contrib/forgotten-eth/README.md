...
## Totals
217 self-claimable EOA owners · ~275.8 ETH · all 6 absent from the current 259-entry registry.

| key | name | owners | ETH | recovery |
|---|---|---:|---:|---|
| digipulse_token_sale | DigiPulse (DGT) Token Sale | 79 | 97.08 | `refundEther()` |
...
| blocklancer_ico | Blocklancer (LNC) Token Sale | 28 | 21.66 | `refund()` |
